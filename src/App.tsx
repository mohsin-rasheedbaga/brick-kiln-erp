    ...
    <>
      <Routes>
        ...
        >
          ...
          <Route path="pos" element={<RequirePermission code="sales.create"><POSSalesPage /></RequirePermission>} />
          <Route path="products" element={<RequirePermission code="stock.view"><ProductsPage /></RequirePermission>} />
